...
const Home: FC<HomeProps> = () => {
    ...
    return (
        <HomeContainer initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{delay: .3}} viewport={{once: true}} id={'Home'} data-testid={'home-container'}>
            ...
            <SocialGroup>
                <FacebookButton tab-index={5} whileHover={{scale: 1.1, transition: { ease: "easeInOut", duration: .2, delay: 0 }}} whileTap={{ scale: .9}} initial={{opacity: 0}} whileInView={{opacity: 1, transition: {delay: 2.7, duration: .7} }}  viewport={{once: true}} data-testid={'home-social-facebook'}/>
                <InstagramButton tab-index={6} whileHover={{scale: 1.1, transition: { ease: "easeInOut", duration: .2, delay: 0 }}} whileTap={{ scale: .9}} initial={{opacity: 0}} whileInView={{opacity: 1, transition: {delay: 2.76, duration: .7}}} viewport={{once: true}} data-testid={'home-social-instagram'}/>
                <LinkedInButton tab-index={7} whileHover={{scale: 1.1, transition: { ease: "easeInOut", duration: .2, delay: 0 }}} whileTap={{ scale: .9}} initial={{opacity: 0}} whileInView={{opacity: 1, transition: {delay: 2.82, duration: .7}}} viewport={{once: true}} data-testid={'home-social-linkedin'}/>
                <TwitterButton tab-index={8} whileHover={{scale: 1.1, transition: { ease: "easeInOut", duration: .2, delay: 0 }}} whileTap={{ scale: .9}} initial={{opacity: 0}} whileInView={{opacity: 1, transition: {delay: 2.88, duration: .7}}}  viewport={{once: true}} data-testid={'home-social-twitter'}/>
                <YoutubeButton tab-index={9} whileHover={{scale: 1.1, transition: { ease: "easeInOut", duration: .2, delay: 0 }}} whileTap={{ scale: .9}} initial={{opacity: 0}} whileInView={{opacity: 1, transition: {delay: 2.92, duration: .7}}} viewport={{once: true}} data-testid={'home-social-youtube'}/>
            </SocialGroup>
            <Link  tab-index={10} ignoreCancelEvents={true} isDynamic={true} onSetActive={() => {}} spy={true} smooth={'easeInQuad'} offset={-30} delay={-500} duration={300} to={navigationArrowLink}  data-testid={'home-navigation-arrow-link'}>
