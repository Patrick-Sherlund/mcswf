...
describe('<Home />', () => {
  ...
  test('It should contain the title, description, social media buttons and navigation arrow', () => {
    ...
    const homeTitlePrimary: HTMLElement = container.getByTestId('home-title-top-primary')
    const homeTitleDivider: HTMLElement = container.getByTestId('home-title-divider')
    const homeTitleSecondary: HTMLElement = container.getByTestId('home-title-top-secondary')
    const homeContentLight: HTMLElement = container.getByTestId('home-content-light')
    const homeContentBold: HTMLElement = container.getByTestId('home-content-bold')
    const homeSocialFacebook: HTMLElement = container.getByTestId('home-social-facebook')
    const homeSocialInstagram: HTMLElement = container.getByTestId('home-social-instagram')
    const homeSocialLinkedin: HTMLElement = container.getByTestId('home-social-linkedin')
    const homeSocialTwitter: HTMLElement = container.getByTestId('home-social-twitter')
    const homeSocialYoutube: HTMLElement = container.getByTestId('home-social-youtube')
